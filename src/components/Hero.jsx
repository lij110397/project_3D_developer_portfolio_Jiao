...
const Hero = () => {
  return <section className='relative w-full h-screen mx-auto'>
    <div className={`${styles.paddingX} absolute top-[120px] inset-0 max-w-7xl mx-auto flex flex-row items-start gap-5`}>
      ...
      <div className="mx-10">
        <h1 className={`${styles.heroHeadText}`}>Hi, I am <span className="text-[#915eff]">Jiao Li</span></h1>
        <p className={`${styles.heroSubText} mt-4 text-white-100`}>I am A Frontend Developer, <br className="block md:hidden"/>A UX designer and <br className="block md:hidden"/>A coming full-stack developer.</p>
      </div>
    </div>
    <ComputersCanvas />
